        ...
        <div class="card col" style="width: 18rem;">
                <img src="${producto.foto}" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <button id="btnCarritoPr" class="btn btn-primary ${producto.id}">
                            $${producto.precio}
                        </button>
                    </div>
        </div>
                            `
            ;
        const botones = document.querySelectorAll('#btnCarritoPr')
...
const agregarAlCarrito = (prodID) => {
    const pedido = stockProductos.find((prod) => prod.id === prodID)
    carrito.push(pedido)
